...
export const DiagramCard = ({
  ...
  const thumbnail = isDark
    ? (diagram.thumbnailDark ?? diagram.thumbnailLight)
    : (diagram.thumbnailLight ?? diagram.thumbnailDark);
      ...
      <div className="bg-accent/50 relative flex h-28 items-center justify-center">
        ...
        >
          ...
          >
            ...
            <img src={thumbnail ?? undefined} alt="" className="h-full w-full object-contain p-2" />
          </Show>
        </Link>
